...
<body>
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-number"><?= array_sum(array_column($sessions, 'responses')) ?></div>
                <div class="stat-label">Total Responses</div>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?= count(array_filter($sessions, function($s) { return $s['status'] == 'active'; })) ?></div>
        ...
        <div class="recent-section">
            <h2><i class="fas fa-question-circle me-2"></i>เลือกประเภทคำถาม</h2>
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div class="session-meta">
                            ...
                            <span class="ms-3"><i class="fas fa-users me-1"></i><?= $session['responses'] ?> responses</span>
